        ...
        <div class="w-full max-w-2xl px-6 py-12">
            ...
            <div class="w-full px-0 md:px-6 py-12">
                <div class="flex items-center bg-gray-200">
                    ...
                    <div class="w-1/4 text-right text-gray-600 py-2 px-4 font-semibold">Presence</div>
                </div>
                @foreach ($student->presences as $presence)
                    <div class="flex items-center justify-between border border-gray-200 -mb-px">
                        <div class="w-1/4 text-left text-gray-600 py-2 px-4 font-medium">{{ $presence->presence_date }}</div>
                        <div class="w-1/4 text-left text-gray-600 py-2 px-4 font-medium">{{ $presence->class->class_name }}</div>
                        <div class="w-1/4 text-left text-gray-600 py-2 px-4 font-medium">{{ $presence->teacher->user->name }}</div>
