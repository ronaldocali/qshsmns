...
@section('content')
    <div class="create">
        ...
        <div class="w-full mt-8 thePresenceDiv">
            <form action="{{ route('presence.index') }}" method="GET" class="md:flex md:items-center md:justify-between px-6 py-6 pb-0">
