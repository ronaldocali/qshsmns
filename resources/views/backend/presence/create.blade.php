...
@section('content')
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Presence for {{ $class->class_name }}</h2>
            </div>
        ...
        <div class="w-full mt-8 bg-white rounded">
            ...
            <div class="w-full px-6 py-6">
                <div class="flex items-center bg-gray-200 rounded-tl rounded-tr">
                    ...
                    <div class="w-5/12 text-right text-gray-600 py-2 px-4 font-semibold">Presence</div>
                </div>
                <form action="{{ route('teacher.presence.store') }}" method="POST">
                        ...
                        <div class="flex items-center justify-between border border-gray-200">
                            ...
                            <div class="w-5/12 text-sm text-right py-2 px-4 flex items-center justify-end">
                                <label class="block text-gray-500 font-semibold sm:border-r sm:pr-4">
                                    <input name="presences[{{ $student->id }}]" class="leading-tight" type="radio" value="present">
                                    <span class="text-sm">Present</span>
                                </label>
                                <label class="ml-4 block text-gray-500 font-semibold">
                                    <input name="presences[{{ $student->id }}]" class="leading-tight" type="radio" value="absent">
