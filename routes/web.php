...
{
    Route::post('presence', 'PresenceController@store')->name('teacher.presence.store');
    Route::get('presence-create/{classid}', 'PresenceController@createByTeacher')->name('teacher.presence.create');
});

Route::group(['middleware' => ['auth','role:Parent']], function () 
{
    Route::get('presence/{presence}', 'PresenceController@show')->name('presence.show');
});
